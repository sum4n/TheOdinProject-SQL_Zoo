...
-- 7.
-- Two ways to be big: A country is big if it has an area of more than 3 million sq km or it has a population of 
...
-- Missing decimals
-- For some version of SQL the division of an integer by an integer will be an integer. One way to prevent this is to 
-- divide by a floating point number such as 1000000.0.
