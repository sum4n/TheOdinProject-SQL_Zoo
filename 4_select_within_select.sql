...
SELECT name, CONCAT (ROUND(population/((SELECT population FROM world WHERE name='Germany')/100.0), 0), '%') AS percentage
FROM world
...
-- gdp > 0 is required because some contries may have null gdp.
